...
class DAGDetail:
    ...
    airflow/stable/_api/airflow/models/dag/index.html#airflow.models.dag.DAG)
        ...
        Attributes:
            ...
            next_dagrun_create_after (datetime.datetime | None | Unset): Earliest time at which this ``next_dagrun`` can be
                ...
                *New in version 2.3.0*
            timezone (str | Unset):
            catchup (bool | None | Unset):
            orientation (None | str | Unset):
            concurrency (float | None | Unset):
            start_date (datetime.datetime | None | Unset): The DAG's start date.

                *Changed in version 2.0.1*&#58; Field becomes nullable.
            dag_run_timeout (None | TimeDeltaType0 | Unset): Time delta
            dataset_expression (DAGDetailDatasetExpressionType0 | None | Unset): Nested dataset any/all conditions
            doc_md (None | str | Unset):
            params (DAGDetailParams | Unset): User-specified DAG params.

                *New in version 2.0.1*
            end_date (datetime.datetime | None | Unset): The DAG's end date.

                *New in version 2.3.0*.
            is_paused_upon_creation (bool | None | Unset): Whether the DAG is paused upon creation.

                *New in version 2.3.0*
            last_parsed (datetime.datetime | None | Unset): The last time the DAG was parsed.

                *New in version 2.3.0*
            template_search_path (list[str] | None | Unset): The template search path.

                *New in version 2.3.0*
            render_template_as_native_obj (bool | None | Unset): Whether to render templates as native Python objects.
    ...
    catchup: bool | None | Unset = UNSET
    orientation: None | str | Unset = UNSET
    concurrency: float | None | Unset = UNSET
    start_date: datetime.datetime | None | Unset = UNSET
    dag_run_timeout: None | TimeDeltaType0 | Unset = UNSET
    dataset_expression: DAGDetailDatasetExpressionType0 | None | Unset = UNSET
    doc_md: None | str | Unset = UNSET
    params: DAGDetailParams | Unset = UNSET
    end_date: datetime.datetime | None | Unset = UNSET
    is_paused_upon_creation: bool | None | Unset = UNSET
    last_parsed: datetime.datetime | None | Unset = UNSET
    template_search_path: list[str] | None | Unset = UNSET
    render_template_as_native_obj: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        dag_run_timeout: dict[str, Any] | None | Unset
        ...
        dataset_expression: dict[str, Any] | None | Unset
        ...
        is_paused_upon_creation: bool | None | Unset
        ...
        template_search_path: list[str] | None | Unset
        ...
        render_template_as_native_obj: bool | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_catchup(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_orientation(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_concurrency(data: object) -> float | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dag_run_timeout(data: object) -> None | TimeDeltaType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dataset_expression(data: object) -> DAGDetailDatasetExpressionType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(DAGDetailDatasetExpressionType0 | None | Unset, data)

        dataset_expression = _parse_dataset_expression(d.pop("dataset_expression", UNSET))

        def _parse_doc_md(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_paused_upon_creation(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_last_parsed(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_template_search_path(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_render_template_as_native_obj(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
