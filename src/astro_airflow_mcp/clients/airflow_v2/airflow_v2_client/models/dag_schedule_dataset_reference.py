...
class DagScheduleDatasetReference:
    ...
    *New in version 2.4.0*
        ...
        Attributes:
            dag_id (None | str | Unset): The DAG ID that depends on the dataset.
            created_at (str | Unset): The dataset reference creation time
            updated_at (str | Unset): The dataset reference update time
    """
