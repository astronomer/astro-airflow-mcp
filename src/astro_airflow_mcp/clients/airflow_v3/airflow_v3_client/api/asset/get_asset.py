...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/assets/{asset_id}".format(
...
) -> AssetResponse | HTTPExceptionResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AssetResponse | HTTPExceptionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AssetResponse | HTTPExceptionResponse | HTTPValidationError
    """
