...
) -> HTTPExceptionResponse | HTTPValidationError | QueuedEventResponse | None:
    if response.status_code == 200:
        response_200 = QueuedEventResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPExceptionResponse | HTTPValidationError | QueuedEventResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPExceptionResponse | HTTPValidationError | QueuedEventResponse
    """
