...
from ...models.dag_run_patch_body import DAGRunPatchBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DAGRunPatchBody): DAG Run Serializer for PATCH requests.
