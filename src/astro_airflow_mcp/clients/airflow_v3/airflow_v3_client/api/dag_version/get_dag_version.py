...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/dags/{dag_id}/dagVersions/{version_number}".format(
...
) -> DagVersionResponse | HTTPExceptionResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = DagVersionResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DagVersionResponse | HTTPExceptionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DagVersionResponse | HTTPExceptionResponse | HTTPValidationError
    """
