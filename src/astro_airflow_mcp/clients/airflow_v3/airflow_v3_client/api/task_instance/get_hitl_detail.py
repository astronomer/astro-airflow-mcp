...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/hitlDetails".format(
...
) -> HITLDetail | HTTPExceptionResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = HITLDetail.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HITLDetail | HTTPExceptionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HITLDetail | HTTPExceptionResponse | HTTPValidationError
    """
