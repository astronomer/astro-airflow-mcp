...
def _get_kwargs(
    ...
    *,
    ...
    task_display_name_pattern: None | str | Unset = UNSET,
    ...
    json_task_display_name_pattern: None | str | Unset
    if isinstance(task_display_name_pattern, Unset):
        json_task_display_name_pattern = UNSET
    else:
        json_task_display_name_pattern = task_display_name_pattern
    params["task_display_name_pattern"] = json_task_display_name_pattern
...
def sync_detailed(
    ...
    *,
    ...
    This endpoint allows specifying `~` as the dag_id, dag_run_id to retrieve Task Instances for all
    DAGs
    and DAG runs.
    ...
    Args:
        ...
        task_display_name_pattern (None | str | Unset): SQL LIKE expression — use `%` / `_`
