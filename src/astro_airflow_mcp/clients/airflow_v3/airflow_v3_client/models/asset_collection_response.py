...
T = TypeVar("T", bound="AssetCollectionResponse")
...
class AssetCollectionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_collection_response = cls(
            assets=assets,
            total_entries=total_entries,
        )

        asset_collection_response.additional_properties = d
        return asset_collection_response
