...
T = TypeVar("T", bound="BulkCreateActionBulkTaskInstanceBody")


@_attrs_define
class BulkCreateActionBulkTaskInstanceBody:
    """
    Attributes:
        action (Literal['create']): The action to be performed on the entities.
        entities (list[BulkTaskInstanceBody]): A list of entities to be created.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_create_action_bulk_task_instance_body = cls(
            action=action,
            entities=entities,
            action_on_existence=action_on_existence,
        )

        return bulk_create_action_bulk_task_instance_body
