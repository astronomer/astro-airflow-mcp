...
T = TypeVar("T", bound="BulkCreateActionConnectionBody")


@_attrs_define
class BulkCreateActionConnectionBody:
    """
    Attributes:
        action (Literal['create']): The action to be performed on the entities.
        entities (list[ConnectionBody]): A list of entities to be created.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_create_action_connection_body = cls(
            action=action,
            entities=entities,
            action_on_existence=action_on_existence,
        )

        return bulk_create_action_connection_body
