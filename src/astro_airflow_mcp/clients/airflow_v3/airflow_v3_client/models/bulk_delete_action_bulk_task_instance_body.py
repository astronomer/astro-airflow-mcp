...
T = TypeVar("T", bound="BulkDeleteActionBulkTaskInstanceBody")


@_attrs_define
class BulkDeleteActionBulkTaskInstanceBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_delete_action_bulk_task_instance_body = cls(
            action=action,
            entities=entities,
            action_on_non_existence=action_on_non_existence,
        )

        return bulk_delete_action_bulk_task_instance_body
