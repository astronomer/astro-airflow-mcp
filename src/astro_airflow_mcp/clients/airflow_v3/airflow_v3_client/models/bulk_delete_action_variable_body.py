...
T = TypeVar("T", bound="BulkDeleteActionVariableBody")


@_attrs_define
class BulkDeleteActionVariableBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_delete_action_variable_body = cls(
            action=action,
            entities=entities,
            action_on_non_existence=action_on_non_existence,
        )

        return bulk_delete_action_variable_body
