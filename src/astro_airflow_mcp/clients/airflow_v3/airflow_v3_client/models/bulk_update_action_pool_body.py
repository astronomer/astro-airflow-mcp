...
T = TypeVar("T", bound="BulkUpdateActionPoolBody")


@_attrs_define
class BulkUpdateActionPoolBody:
    """
    Attributes:
        action (Literal['update']): The action to be performed on the entities.
        entities (list[PoolBody]): A list of entities to be updated.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_update_action_pool_body = cls(
            action=action,
            entities=entities,
            action_on_non_existence=action_on_non_existence,
        )

        return bulk_update_action_pool_body
