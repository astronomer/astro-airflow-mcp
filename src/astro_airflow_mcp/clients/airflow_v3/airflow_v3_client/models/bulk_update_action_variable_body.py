...
T = TypeVar("T", bound="BulkUpdateActionVariableBody")
...
class BulkUpdateActionVariableBody:
    ...
    Attributes:
        ...
        entities (list[VariableBody]): A list of entities to be updated.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_update_action_variable_body = cls(
            action=action,
            entities=entities,
            action_on_non_existence=action_on_non_existence,
        )

        return bulk_update_action_variable_body
