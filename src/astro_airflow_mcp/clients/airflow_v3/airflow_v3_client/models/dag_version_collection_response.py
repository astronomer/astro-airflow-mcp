...
T = TypeVar("T", bound="DAGVersionCollectionResponse")
...
class DAGVersionCollectionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dag_version_collection_response = cls(
            dag_versions=dag_versions,
            total_entries=total_entries,
        )

        dag_version_collection_response.additional_properties = d
        return dag_version_collection_response
