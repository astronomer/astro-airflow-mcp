...
T = TypeVar("T", bound="ImportErrorCollectionResponse")
...
class ImportErrorCollectionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for import_errors_item_data in _import_errors:
            import_errors_item = ImportErrorResponse.from_dict(import_errors_item_data)

            import_errors.append(import_errors_item)

        total_entries = d.pop("total_entries")

        import_error_collection_response = cls(
            import_errors=import_errors,
            total_entries=total_entries,
        )

        import_error_collection_response.additional_properties = d
        return import_error_collection_response
