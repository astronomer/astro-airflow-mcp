...
T = TypeVar("T", bound="LastAssetEventResponse")


@_attrs_define
class LastAssetEventResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        last_asset_event_response = cls(
            id=id,
            timestamp=timestamp,
        )

        last_asset_event_response.additional_properties = d
        return last_asset_event_response
