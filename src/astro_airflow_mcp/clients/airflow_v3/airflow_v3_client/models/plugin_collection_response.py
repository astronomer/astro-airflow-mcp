...
T = TypeVar("T", bound="PluginCollectionResponse")


@_attrs_define
class PluginCollectionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plugin_collection_response = cls(
            plugins=plugins,
            total_entries=total_entries,
        )

        plugin_collection_response.additional_properties = d
        return plugin_collection_response
