...
T = TypeVar("T", bound="TaskInstanceHistoryCollectionResponse")
...
class TaskInstanceHistoryCollectionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for task_instances_item_data in _task_instances:
            task_instances_item = TaskInstanceHistoryResponse.from_dict(task_instances_item_data)

            task_instances.append(task_instances_item)

        total_entries = d.pop("total_entries")

        task_instance_history_collection_response = cls(
            task_instances=task_instances,
            total_entries=total_entries,
        )

        task_instance_history_collection_response.additional_properties = d
        return task_instance_history_collection_response
