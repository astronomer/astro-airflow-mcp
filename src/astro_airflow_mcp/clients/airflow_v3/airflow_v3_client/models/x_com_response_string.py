...
T = TypeVar("T", bound="XComResponseString")


@_attrs_define
class XComResponseString:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        x_com_response_string.additional_properties = d
        return x_com_response_string
